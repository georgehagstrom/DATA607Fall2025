...
load into R and visualize. If you know of a website with an API that isn't listed here, you may use it but be aware that this list is curated so there is a better chance
that it will be easy to learn how to use the APIs on the websites listed here. I recommend choosing an API that doesn't require authentication. If authentication is required, 
make sure _not_ to share you credentials.
...
You should incorporate your vignette into a shared `github` repository which will contain all of the examples. I have created the following repository for you to use for this assignment:
 ...
 [https://github.com/georgehagstrom/Fall2025TIDYVERSE](https://github.com/georgehagstrom/Fall2025TIDYVERSE)
